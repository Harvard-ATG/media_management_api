...
from media_management_api.media_service.models import Collection, Course
...
class IiifView(APIView):
    def get(self, request, format=None):
        return Response(
            {
                "collections": reverse(
                    "api:iiif:collections", request=request, format=format
                ),
            }
        )
...
class IiifManifestView(APIView):
    def get(
        self, request, manifest_id=None, object_type=None, object_id=None, format=None
    ):
            ...
            data["members"].append(
                {
                    ...
                    "@id": request.build_absolute_uri(
                        reverse("api:iiif:collection", kwargs={"pk": c.pk})
                    ),
                    "label": c.title,
                }
            )
...
class IiifCollectionView(APIView):
    def get(self, request, pk=None, format=None):
        ...
        data = {
            ...
            "@type": "sc:Collection",
            "@id": request.build_absolute_uri(
                reverse("api:iiif:collection", kwargs={"pk": pk})
            ),
            ...
            data["members"].append(
                {
                    "@type": "sc:Manifest",
                    "@id": request.build_absolute_uri(
                        reverse("api:iiif:manifest", kwargs={"manifest_id": c.pk})
                    ),
                    "label": c.title,
                }
            )
