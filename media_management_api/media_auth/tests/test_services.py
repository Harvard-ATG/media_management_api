...
from ..services import decode_jwt, get_client_key, get_course_user, has_required_data
...
class JWTAuthTest(unittest.TestCase):
    ...
    def test_get_client_key_bad_client_id(self):
    ...
    def test_get_course_user(self):
        ...
        verified_course_user = CourseUser.objects.get(
            course=test_course, user_profile=course_user.profile
        )
    ...
    def test_get_course_user_course_does_not_exist(self):
        token = {"user_id": 12, "course_id": 12000301123, "course_permission": "read"}
