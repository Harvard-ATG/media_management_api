...
urlpatterns = [
    ...
    url(r'^courses/(?P<pk>[^/.]+)/$', course_detail, name='course-detail'),
    url(r'^courses/(?P<pk>[^/.]+)/collections/$', views.CourseCollectionsView.as_view(), name='course-collections'),
    url(r'^courses/(?P<pk>[^/.]+)/images/$', views.CourseImagesView.as_view(), name='course-images'),
